        ...
        <form action="" method="post">
            <div class="row justify-content-end">
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <input type="text" name="keyword" id="keyword" class="form-control w-75 d-inline keyword"
                           placeholder="Masukan Pencarian...." autocomplete="off">
                    &nbsp;
                    &nbsp;
                    <button type="submit" name="cari" class="btn btn-info text-white d-inline tombol-cari">Cari!</button>
                </div>
            </div>
        </form>
        <br>
                    ...
                    <?php if (!empty($students)) { ?>
                        ...
                        <?php foreach ($students as $student) { ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                <td>
                                    <img src="img/<?= $student['gambar']; ?>" alt="Gambar"
