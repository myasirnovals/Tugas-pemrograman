						...
						<?php
							...
							if (isset($_POST['submit'])) {
								...
								if (count($errors)>0) {
									...
									$sql = "UPDATE produk SET id='$id', nama_produk='$nama_produk', harga='$harga', keterangan_produk='$keterangan_produk', gambar_produk='$new_foto_name', tanggal_exp='$new_foto_name' WHERE id='$id'";
									$result = mysqli_query($connect, $sql);
									if ($result) {
										echo "<div class='alert alert-success'>Produk sudah berhasil di edit</div>";
									} else {
						  ...
						  <div class="card-body">
							<form action="" method="post" enctype="multipart/form-data">
								<div class="mb-3">
							    	...
							    	<input type="text" name="nama_produk" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $nama_produk?>">
							  	</div>
							  	<div class="mb-3">
							    	<label for="exampleInputPassword1" class="form-label">Keterangan</label>
							    	<input type="text" name="keterangan_produk" class="form-control" id="exampleInputPassword1" value="<?php echo $keterangan_produk?>">
							  	</div>
							  	<div class="mb-3">
							    	<label for="exampleInputHarga1" class="form-label">Harga</label>
							    	<input type="text" name="harga" class="form-control" id="exampleInputHarga1" value="<?php echo $harga ?>">
							  	</div>
								...
								<div class="mb-3">
							    	...
							    	<input type="date" name="tanggal_exp" class="form-control" id="exampleInputDate1" value="<?php echo $tanggal_exp ?>">
							  	</div>
