...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    foreach ($array_data as $row) {
        if (($row['email'] == $_POST['email'])) {
            ...
            echo "<script>alert('Profile gagal di update'); document.location.href = '../view/user/profile.php';</script>";
    ...
    if (file_put_contents($data_member, UpdateProfile())) {
        echo "<script>alert('Profile berhasil di update'); document.location.href = '../view/user/profile.php';</script>";
    } else {
        echo "<script>alert('Profile gagal di update'); document.location.href = '../view/user/profile.php';</script>";
    }
}