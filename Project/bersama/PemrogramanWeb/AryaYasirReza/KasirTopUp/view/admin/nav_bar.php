<nav class="navbar navbar-expand-md bg-body py-3" style="background-color: #2c2546 !important;" >
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span
                    ...
                    </svg></span><span class="text-white">Brand</span></a>
        ...
        <div class="collapse navbar-collapse" id="navcol-3">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link text-white" href="member.php">Members</a></li>
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="add_game.php">Add Game</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
