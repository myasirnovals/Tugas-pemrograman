      ...
      <div class="row">
        ...
        <div class="col-md-3 col-lg-2 p-0 bg-white sidebar">
          <div class="d-flex flex-column p-3">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              ...
              <li class="nav-item mb-2">
                <a href="kamar.html" class="nav-link active">
        ...
        <div class="col-md-9 col-lg-10 content">
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addKamarModal"><i class="bi bi-plus-circle me-2"></i>Tambah Kamar</button>
          </div>
